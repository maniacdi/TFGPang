...
public class AspectUtility:MonoBehaviour{
    ...
    public static void setCamera(){
        ...
        //usar un full-screen si no hay nada previo establecido
        ...
        if (!backgroundCam)
        {
         backgroundCam=new GameObject("BackCam", typeof(Camera)).GetComponent<Camera>();
    ...
    public static Rect screenRect{
        get{
            return new Rect(cam.rect.y * Screen.width, cam.rect.y * Screen.height, cam.rect.width*Screen.width, cam.rect.height * Screen.height);
        }
    }
